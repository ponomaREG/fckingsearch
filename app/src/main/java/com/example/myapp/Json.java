...
public class Json {
    ...
    private final static String SEARCH_API = "http://161.35.108.15:5555/api/get?q=%s&count=20&page=%d";
    private final static String SEARCH_API_COUNT = "http://161.35.108.15:5555/api/get/count?q=%s";
